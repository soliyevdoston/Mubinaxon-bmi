    ...
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-4">
        ...
        <button
          ...
          className="rounded-[6px] border border-dashed border-[hsl(var(--border))] p-4 flex flex-col items-center justify-center gap-2 text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--foreground))] hover:border-[hsl(var(--border))]/60 transition-colors min-h-[120px]"
        >
        ...
        <div className="rounded-[6px] border border-[hsl(var(--border))] p-5">
          ...
          >
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="h-9 px-4 rounded-[6px] bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] text-sm font-medium hover:bg-[hsl(var(--primary))]/90 transition-colors"
              >
                Saqlash
              </button>
              <button
                type="button"
                onClick={resetForm}
                className="h-9 px-4 rounded-[6px] border border-[hsl(var(--border))] text-sm hover:bg-[hsl(var(--muted))] transition-colors"
              >
                Bekor qilish
              </button>
            </div>
