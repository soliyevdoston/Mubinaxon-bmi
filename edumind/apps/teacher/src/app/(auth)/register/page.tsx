    ...
    <div className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))]">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mt-1">O'qituvchi hisobi yaratish</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="text-sm font-medium">To'liq ism</label>
            <input name="fullName" required placeholder="Sardor Xasanov" className={inputClass} />
          </div>
          <div className="space-y-1.5">
