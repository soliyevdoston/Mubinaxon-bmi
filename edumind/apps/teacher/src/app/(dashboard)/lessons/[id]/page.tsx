  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href={`/lessons/${lesson.id}/edit`} className="inline-flex items-center gap-2 h-9 px-4 rounded-[6px] border border-[hsl(var(--border))] text-sm hover:bg-[hsl(var(--muted))] transition-colors">
