...
import { LayoutDashboard, BookOpen, Radio, Users, BarChart3, Settings, LogOut } from 'lucide-react'
    ...
    <aside className="fixed left-0 top-0 h-full w-64 border-r border-[hsl(var(--border))] bg-[hsl(var(--background))] flex flex-col">
      <div className="px-6 py-5 border-b border-[hsl(var(--border))]">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-semibold text-sm tracking-tight">EduMind</span>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-[hsl(var(--border))]">
        ...
        <button onClick={() => signOut({ callbackUrl: '/login' })} className="flex items-center gap-3 w-full px-3 py-2 rounded-[6px] text-sm text-[hsl(var(--muted-foreground))] hover:text-[hsl(var(--destructive))] hover:bg-[hsl(var(--destructive))]/5 transition-colors">
