            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button type="submit" disabled={pending}
                  className="flex-1 inline-flex items-center justify-center gap-2 h-9 rounded-[6px] bg-[hsl(var(--primary))] text-[hsl(var(--primary-foreground))] text-sm font-medium hover:bg-[hsl(var(--primary))]/90 disabled:opacity-50 transition-colors">
                  {pending && <Loader2 className="w-4 h-4 animate-spin" />} Yaratish
                </button>
              </div>
            </form>
          </div>
